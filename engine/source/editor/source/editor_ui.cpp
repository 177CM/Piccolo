...
namespace Piccolo
{
    ...
    void EditorUI::showEditorMenu(bool* p_open)
    {
        ...
        if (ImGui::BeginMenuBar())
        {
            ...
            {
                if (ImGui::MenuItem(g_runtime_global_context.m_render_debug_config->mazeShowWay.show_way ?
                                        "show off way" :
                                        "show show way"))
                {
                    LOG_INFO("Show Maze btn be pressed!");
                    g_runtime_global_context.m_render_debug_config->mazeShowWay.show_way =
                        !g_runtime_global_context.m_render_debug_config->mazeShowWay.show_way;
                }
                ImGui::EndMenu();
            }
